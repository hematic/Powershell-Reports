...
$TopUsers = 200 # Set this value to the number of users with large tokens that you want to report on.
$TokensSizeThreshold = 6000 # Set this to the size in bytes that you want to capture the user information for the report.
$ProgressBar = $True # Set this value to true if you want to see the progress bar.
$ConsoleOutput = $True # Set this value to true if you want to output to the console
$OutputSummary = $True # Set this value to true if you want a summary output to the console when the script has completed.
$UseTokenGroups = $True # Set this value to true to use the tokenGroups attribute
$UseGetAuthorizationGroups = $False # Set this value to true to use the GetAuthorizationGroups() method
